...
class LiveLesson(db.Model):
    ...
    is_live = db.Column(db.Boolean, default=False)  # <-- ADD THIS LINE
    course = db.relationship('Course', backref='live_lessons')
...
class Notification(db.Model):
    ...
    created_by = db.Column(db.Integer, db.ForeignKey('users.id'))  # optional: link to User model
